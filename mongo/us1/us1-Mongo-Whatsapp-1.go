...
func GenerateUs1MongoWhatsappTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{cloudformation.ImportValue("us1-SecurityGroup-MongoWhatsappEc2InstanceEC2SecurityGroupId")}
	...
	mongoReplicaInstance006005.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	mongoReplicaInstance006006.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	mongoReplicaInstance006020.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	mongoReplicaInstance013020.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	mongoReplicaInstance013020.Ec2Instance.InstanceType = cloudformation.String("t2.large")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/us1/Mongo-Whatsapp", "us1-Mongo-Whatsapp-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/us1/Mongo-Whatsapp", "us1-Mongo-Whatsapp-1-Service.json")
}
