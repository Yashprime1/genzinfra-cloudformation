...
func GenerateMec1MongoAuditTemplate() {
	...
	MongoReplicaSetInstance010005.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance010005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.10.5") //primary
	...
	MongoReplicaSetInstance010021.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance010021.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.10.21")
	...
	MongoReplicaSetInstance010037.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance010037.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.10.37")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/mec1/Mongo-Audit-1", "mec1-Mongo-Audit-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/mec1/Mongo-Audit-1", "mec1-Mongo-Audit-1-Service.json")
}
