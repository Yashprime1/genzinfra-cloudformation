...
func GenerateIn1MongoWiredTiger3Dot6Template() {
	...
	defaults.StackName = "in1-Mongo-MetaData-1"
	...
	MongoReplicaSetInstance007007.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	...
	MongoReplicaSetInstance007022.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	...
	MongoReplicaSetInstance007022.Ec2Instance.PrivateIpAddress = cloudformation.String("10.12.7.22") //primary
	...
	MongoReplicaSetInstance007038.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
