...
func GenerateSk1MongoAuditTemplate() {
	...
	MongoReplicaSetInstance010005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.10.5")
	...
	MongoReplicaSetInstance010037.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.10.37") //primary
