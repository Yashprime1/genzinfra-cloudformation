...
func Generatesg1MongoWiredTiger3Dot6Template() {
	...
	defaults.Ec2Instance.ImageId = cloudformation.String("ami-00327857c3a230dba")
	...
	MongoReplicaSetInstance007007.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	...
	MongoReplicaSetInstance007007.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.7")
	...
	MongoReplicaSetInstance007022.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	...
	MongoReplicaSetInstance007022.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.22") //primary
	...
	MongoReplicaSetInstance007038.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	...
	MongoReplicaSetInstance007038.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.38")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/sg1/Mongo-MetaData-1", "sg1-Mongo-MetaData-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/sg1/Mongo-MetaData-1", "sg1-Mongo-MetaData-1-Service.json")
}
