...
func GenerateSk1MongoExtendedStatsTemplate() {
	...
	MongoReplicaSetInstance058004.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.58.4")
	...
	MongoReplicaSetInstance058004.MongoContainerTag = "github-sne-6117-16"
	...
	MongoReplicaSetInstance058036.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.58.36") //primary
