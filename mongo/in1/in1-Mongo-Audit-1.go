...
func GenerateIn1MongoAuditTemplate() {
	...
	defaults.XvdpEc2Volume.Size = cloudformation.Int(128)
	...
	MongoReplicaSetInstance010005.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	...
	MongoReplicaSetInstance010005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.12.10.5")
	...
	MongoReplicaSetInstance010021.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	...
	MongoReplicaSetInstance010021.Ec2Instance.PrivateIpAddress = cloudformation.String("10.12.10.21")
	...
	MongoReplicaSetInstance010037.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	...
	MongoReplicaSetInstance010037.Ec2Instance.PrivateIpAddress = cloudformation.String("10.12.10.37") //primary
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/in1/Mongo-Audit-1", "in1-Mongo-Audit-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/in1/Mongo-Audit-1", "in1-Mongo-Audit-1-Service.json")
}
