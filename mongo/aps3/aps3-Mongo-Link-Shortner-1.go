...
func GenerateAps3MongoLinkShortnerTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{cloudformation.ImportValue("aps3-SecurityGroup-MongoLinkShortenerEc2InstanceEC2SecurityGroupId")}
	defaults.EcsTaskDefinitionCommand = []string{"--dbpath", "/var/lib/mongo", "--replSet", "aps3-mongo-link-shortener-1-rs0", "--logpath", "/var/log/mongodb/mongod.log", "--logappend", "--auth", "--oplogSize", "2048", "--keyFile", "/var/lib/mongodb-keyfile"}
	// Flip this to make all the instances disappear
	defaults.EnableEc2instance = true

	mongoReplicaInstance006133 := mongo.NewMongo(defaults)
	mongoReplicaInstance006133.EnableEc2instance = true
	mongoReplicaInstance006133.Ec2Instance.ImageId = cloudformation.String("ami-0973b8a62b244304e")
	...
	mongoReplicaInstance006133.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.6.133")
	...
	mongoReplicaInstance006133.MongoContainerTag = "github-task-2652-mongo-17"
	...
	mongoReplicaInstance006229.Ec2Instance.ImageId = cloudformation.String("ami-0973b8a62b244304e")
	...
	mongoReplicaInstance006229.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.6.229")
	...
	mongoReplicaInstance006149.Ec2Instance.ImageId = cloudformation.String("ami-0973b8a62b244304e")
	...
	mongoReplicaInstance006149.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.6.149")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/aps3/Mongo-Link-Shortener", "aps3-Mongo-Link-Shortener-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/aps3/Mongo-Link-Shortener", "aps3-Mongo-Link-Shortener-1-Service.json")
}
