...
func GenerateIn1MongoDirectcallTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{
		cloudformation.ImportValue("in1-SecurityGroup-DirectcallMongoInstanceEC2SecurityGroupId"),
	}
	...
	MongoReplicaSetInstance013132.Ec2Instance.ImageId = cloudformation.String("ami-076622203c9703088")
	...
	MongoReplicaSetInstance013132.Ec2Instance.PrivateIpAddress = cloudformation.String("10.12.13.132") //primary
	...
	MongoReplicaSetInstance013132.EnableMongoRegistryCache = false
	...
	MongoReplicaSetInstance013148.Ec2Instance.ImageId = cloudformation.String("ami-0de320fb812039314")
	...
	MongoReplicaSetInstance013148.Ec2Instance.PrivateIpAddress = cloudformation.String("10.12.13.148")
	...
	MongoReplicaSetInstance013164.Ec2Instance.ImageId = cloudformation.String("ami-076622203c9703088")
	...
	MongoReplicaSetInstance013164.Ec2Instance.PrivateIpAddress = cloudformation.String("10.12.13.164")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/in1/Mongo-Directcall-1", "in1-Mongo-Directcall-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/in1/Mongo-Directcall-1", "in1-Mongo-Directcall-1-Service.json")
}
