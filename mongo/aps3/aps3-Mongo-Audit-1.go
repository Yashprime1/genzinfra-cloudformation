...
func GenerateAps3MongoAuditTemplate() {
	...
	MongoReplicaSetInstance010005.Ec2Instance.ImageId = cloudformation.String("ami-0973b8a62b244304e")
	...
	MongoReplicaSetInstance010005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.10.5")
	...
	MongoReplicaSetInstance010021.Ec2Instance.ImageId = cloudformation.String("ami-0973b8a62b244304e")
	...
	MongoReplicaSetInstance010021.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.10.21")
	...
	MongoReplicaSetInstance010037.Ec2Instance.ImageId = cloudformation.String("ami-0973b8a62b244304e")
	...
	MongoReplicaSetInstance010037.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.10.37") //primary
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/aps3/Mongo-Audit-1", "aps3-Mongo-Audit-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/aps3/Mongo-Audit-1", "aps3-Mongo-Audit-1-Service.json")
}
