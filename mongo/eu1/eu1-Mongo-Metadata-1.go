...
func GenerateEu1MongoMetadataTemplate() {
	...
	MongoReplicaSetInstance007007.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.7.7") //primary
	...
	MongoReplicaSetInstance007022.Ec2Instance.ImageId = cloudformation.String("ami-0251986887b4fb951")
	...
	MongoReplicaSetInstance007038.Ec2Instance.ImageId = cloudformation.String("ami-0251986887b4fb951")
	...
	MongoReplicaSetInstance007038.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.7.38")
