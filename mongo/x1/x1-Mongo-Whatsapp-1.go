...
func GenerateX1MongoWhatsappTemplate() {
	...
	defaults.Ec2Instance.ImageId = cloudformation.String("ami-04b18275a0f59862d")
	defaults.Ec2Instance.DisableApiTermination = cloudformation.Bool(false)
	defaults.EnableCadvisorArtifactoryRepository = true
	defaults.Ec2Instance.SecurityGroupIds = []string{cloudformation.ImportValue("x1-SecurityGroup-MongoWhatsappEc2InstanceEC2SecurityGroupId")}
	...
	mongoReplicaInstance006005.Ec2Instance.ImageId = cloudformation.String("ami-00ac255069dc94e3c")
	mongoReplicaInstance006005.Ec2Instance.InstanceType = cloudformation.String("t2.small")
	mongoReplicaInstance006005.Ec2InstanceSubnet = subnetA
	mongoReplicaInstance006005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.6.5") //primary
	...
	mongoReplicaInstance006006.Ec2Instance.ImageId = cloudformation.String("ami-00ac255069dc94e3c")
	mongoReplicaInstance006006.Ec2Instance.InstanceType = cloudformation.String("t2.small")
	mongoReplicaInstance006006.Ec2InstanceSubnet = subnetA
	mongoReplicaInstance006006.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.6.6")
	...
	mongoReplicaInstance006020.Ec2Instance.ImageId = cloudformation.String("ami-00ac255069dc94e3c")
	mongoReplicaInstance006020.Ec2Instance.InstanceType = cloudformation.String("t2.small")
	mongoReplicaInstance006020.Ec2InstanceSubnet = subnetB
	mongoReplicaInstance006020.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.6.20")
	...
	mongoReplicaInstance013020.Ec2Instance.ImageId = cloudformation.String("ami-00ac255069dc94e3c")
	mongoReplicaInstance013020.Ec2Instance.InstanceType = cloudformation.String("t2.small")
	mongoReplicaInstance013020.Ec2InstanceSubnet = subnetC
	mongoReplicaInstance013020.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.13.20")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/x1/Mongo-Whatsapp", "x1-Mongo-Whatsapp-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/x1/Mongo-Whatsapp", "x1-Mongo-Whatsapp-1-Service.json")
}
