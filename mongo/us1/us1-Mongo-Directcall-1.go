...
func GenerateUs1MongoDirectcallTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{
		cloudformation.ImportValue("us1-SecurityGroup-DirectcallMongoInstanceEC2SecurityGroupId"),
	}
	...
	MongoReplicaSetInstance013132.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	MongoReplicaSetInstance013148.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	MongoReplicaSetInstance013148.MongoContainerTag = "bamboo-mongo-task-2652-mongo-9"
	...
	MongoReplicaSetInstance013164.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	MongoReplicaSetInstance013164.MongoContainerTag = "bamboo-mongo-task-2652-mongo-9"
	MongoReplicaSetInstance013164.AppendToTemplate(sTemplate, serviceTemplate)

	wizrocket.WriteTemplate(sTemplate, "/mongo/us1/Mongo-Directcall-1", "us1-Mongo-Directcall-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/us1/Mongo-Directcall-1", "us1-Mongo-Directcall-1-Service.json")
}
