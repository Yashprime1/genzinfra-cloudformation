...
func GenerateUs1MongoAuditTemplate() {
	...
	MongoReplicaSetInstance010005.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	MongoReplicaSetInstance010021.Ec2Instance.ImageId = cloudformation.String("ami-02726fee3f464392b")
	...
	MongoReplicaSetInstance010037.Ec2Instance.ImageId = cloudformation.String("ami-0030f75d7382838b8")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/us1/Mongo-Audit-1", "us1-Mongo-Audit-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/us1/Mongo-Audit-1", "us1-Mongo-Audit-1-Service.json")
}
