...
func GenerateMec1MongoIntegrationDebuggerTemplate() {
	...
	subnetA := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "13.176/28", // check for availability of subnet CIDR, we specify 28 to reserve only 16 IPs 10.19.13.176 - 10.19.13.191
	})
	...
	subnetB := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "13.192/28", // check for availability of subnet CIDR, we specify 28 to reserve only 16 IPs 10.19.13.192- 10.19.13.207
	})
	...
	subnetC := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "13.208/28", // check for availability of subnet CIDR, we specify 28 to reserve only 16 IPs 10.19.13.208 - 10.19.13.223
	})
	...
	defaults.Ec2Instance.ImageId = cloudformation.String("ami-0239197e6dab64b3f")
	...
	MongoReplicaSetInstance013180.Ec2Instance.ImageId = cloudformation.String("ami-0239197e6dab64b3f")
	...
	MongoReplicaSetInstance013180.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.13.180") //primary
	...
	MongoReplicaSetInstance013196.Ec2Instance.ImageId = cloudformation.String("ami-0239197e6dab64b3f")
	...
	MongoReplicaSetInstance013196.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.13.196")
	...
	MongoReplicaSetInstance013212.Ec2Instance.ImageId = cloudformation.String("ami-0239197e6dab64b3f")
	...
	MongoReplicaSetInstance013212.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.13.212")
	...
	MongoReplicaSetInstance013212.MongoContainerTag = "bamboo-mongo-sne-6117-3"
	MongoReplicaSetInstance013212.AppendToTemplate(sTemplate, serviceTemplate)

	wizrocket.WriteTemplate(sTemplate, "/mongo/mec1/Mongo-Integration-Debugger-1", "mec1-Mongo-Integration-Debugger-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/mec1/Mongo-Integration-Debugger-1", "mec1-Mongo-Integration-Debugger-1-Service.json")
}
