...
func GenerateSk1MongoWhatsappTemplate() {
	...
	mongoReplicaInstance006005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.6.5")
	...
	mongoReplicaInstance006006.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.6.6") //primary
