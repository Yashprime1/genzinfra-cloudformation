...
func GenerateSk1MongoWiredTiger3Dot6Template() {
	...
	defaults.StackName = "sk1-Mongo-MetaData-1"
	...
	MongoReplicaSetInstance007007.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.7.7")
	...
	MongoReplicaSetInstance007022.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.7.22") //primary
