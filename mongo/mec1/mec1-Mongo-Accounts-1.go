...
func GenerateMec1MongoAccountsTemplate() {
	...
	MongoReplicaSetInstance007052.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
	...
	MongoReplicaSetInstance007052.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.52")
	...
	MongoReplicaSetInstance007068.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
	...
	MongoReplicaSetInstance007068.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.68") //primary
	...
	MongoReplicaSetInstance007100.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
	...
	MongoReplicaSetInstance007100.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.100")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/mec1/mec1-Mongo-Accounts-1", "mec1-Mongo-Accounts-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/mec1/mec1-Mongo-Accounts-1", "mec1-Mongo-Accounts-1-Service.json")
}
