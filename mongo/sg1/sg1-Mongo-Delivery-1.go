...
func GenerateSg1MongoDelivery1Template() {
	...
	MongoReplicaSetInstance007164.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	...
	MongoReplicaSetInstance007164.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.164") 
	...
	MongoReplicaSetInstance007180.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	...
	MongoReplicaSetInstance007180.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.180") // primary
	...
	MongoReplicaSetInstance007196.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
