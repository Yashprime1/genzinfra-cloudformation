...
func GenerateMec1MongoDirectcallTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{
		cloudformation.ImportValue("mec1-SecurityGroup-DirectcallMongoInstanceEC2SecurityGroupId"),
	}
	...
	MongoReplicaSetInstance013132.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance013132.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.13.132") //primary
	...
	MongoReplicaSetInstance013132.MongoContainerTag = "bamboo-mongo-task-2652-mongo-9"
	...
	MongoReplicaSetInstance013148.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance013148.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.13.148")
	...
	MongoReplicaSetInstance013164.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance013164.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.13.164")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/mec1/Mongo-Directcall-1", "mec1-Mongo-Directcall-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/mec1/Mongo-Directcall-1", "mec1-Mongo-Directcall-1-Service.json")
}
