...
func Generateus1MongoWiredTiger3Dot6Template() {
	...
	MongoReplicaSetInstance007007.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.7.7")
	...
	MongoReplicaSetInstance007022.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.7.22") //primary
