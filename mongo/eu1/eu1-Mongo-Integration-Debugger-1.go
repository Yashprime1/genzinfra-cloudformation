...
func GenerateEu1MongoIntegrationDebuggerTemplate() {
	...
	subnetA := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "13.176/28", // check for availability of subnet CIDR, we specify 28 to reserve only 16 IPs 10.11.13.176 - 10.11.13.191
	})
	...
	subnetB := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "13.192/28", // check for availability of subnet CIDR, we specify 28 to reserve only 16 IPs 10.11.13.192- 10.11.13.207
	})
	...
	subnetC := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "13.208/28", // check for availability of subnet CIDR, we specify 28 to reserve only 16 IPs 10.11.13.208 - 10.11.13.223
	})
	...
	defaults.Ec2Instance.ImageId = cloudformation.String("ami-0b21187a4de4bd343")
	...
	MongoReplicaSetInstance013180.Ec2Instance.ImageId = cloudformation.String("ami-0b21187a4de4bd343")
	...
	MongoReplicaSetInstance013180.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.13.180") //primary
	...
	MongoReplicaSetInstance013196.Ec2Instance.ImageId = cloudformation.String("ami-0b21187a4de4bd343")
	...
	MongoReplicaSetInstance013196.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.13.196")
	...
	MongoReplicaSetInstance013212.Ec2Instance.ImageId = cloudformation.String("ami-0b21187a4de4bd343")
	...
	MongoReplicaSetInstance013212.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.13.212")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/eu1/Mongo-Integration-Debugger-1", "eu1-Mongo-Integration-Debugger-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/eu1/Mongo-Integration-Debugger-1", "eu1-Mongo-Integration-Debugger-1-Service.json")
}
