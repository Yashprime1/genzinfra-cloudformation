...
func GenerateMec1MongoDelivery1Template() {
	...
	defaults.EcsTaskDefinitionCommand = []string{"--dbpath", "/var/lib/mongo", "--replSet", "mec1-Mongo-Delivery-1-rs0", "--logpath", "/var/log/mongodb/mongod.log", "--logappend", "--auth", "--oplogSize", "2048", "--keyFile", "/var/lib/mongodb-keyfile"}
	// Flip this to make all the instances disappear
	defaults.EnableEc2instance = true

	MongoReplicaSetInstance007164 := mongo.NewMongo(defaults)
	MongoReplicaSetInstance007164.EnableEc2instance = true
	MongoReplicaSetInstance007164.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance007164.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.164") //primary
	...
	MongoReplicaSetInstance007164.MongoContainerTag = "bamboo-mongo-sne-6117-2"
	...
	MongoReplicaSetInstance007180.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance007180.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.180")
	...
	MongoReplicaSetInstance007196.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance007196.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.196")
	...
	MongoReplicaSetInstance007196.MongoContainerTag = "bamboo-mongo-sne-6117-2"
	MongoReplicaSetInstance007196.AppendToTemplate(sTemplate, serviceTemplate)

	wizrocket.WriteTemplate(sTemplate, "/mongo/mec1/mec1-Mongo-Delivery", "mec1-Mongo-Delivery-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/mec1/mec1-Mongo-Delivery", "mec1-Mongo-Delivery-1-Service.json")
}
