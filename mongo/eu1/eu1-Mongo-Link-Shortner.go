...
func GenerateEu1MongoLinkShortnerTemplate() {
	...
	mongoReplicaInstance006113.Ec2Instance.ImageId = cloudformation.String("ami-0251986887b4fb951")
	...
	mongoReplicaInstance006113.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.6.133")
	...
	mongoReplicaInstance006113.MongoContainerTag = "bamboo-mongo-task-2652-mongo-1"
	...
	mongoReplicaInstance006229.Ec2Instance.ImageId = cloudformation.String("ami-0251986887b4fb951")
	...
	mongoReplicaInstance006229.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.6.229") //primary
	...
	mongoReplicaInstance006149.Ec2Instance.ImageId = cloudformation.String("ami-0c0475d803735333b")
