...
func GenerateMec1MongoStatsTemplate() {
	...
	MongoReplicaSetInstance013197.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
	...
	MongoReplicaSetInstance013197.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.118")
	...
	MongoReplicaSetInstance013213.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
	...
	MongoReplicaSetInstance013213.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.134") //primary
	...
	MongoReplicaSetInstance013229.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
