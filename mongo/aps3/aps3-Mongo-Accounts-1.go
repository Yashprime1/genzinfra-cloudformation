...
func GenerateAps3MongoAccountsTemplate() {
	...
	MongoReplicaSetInstance007052.Ec2Instance.ImageId = cloudformation.String("ami-02873cba8b394e858")
	...
	MongoReplicaSetInstance007052.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.7.52")
	...
	MongoReplicaSetInstance007068.Ec2Instance.ImageId = cloudformation.String("ami-02873cba8b394e858")
	...
	MongoReplicaSetInstance007068.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.7.68") //primary
	...
	MongoReplicaSetInstance007100.Ec2Instance.ImageId = cloudformation.String("ami-02873cba8b394e858")
	...
	MongoReplicaSetInstance007100.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.7.100")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/aps3/aps3-Mongo-Accounts-1", "aps3-Mongo-Accounts-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/aps3/aps3-Mongo-Accounts-1", "aps3-Mongo-Accounts-1-Service.json")
}
