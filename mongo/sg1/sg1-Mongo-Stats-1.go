...
func GenerateSg1MongoStatsTemplate() {
	...
	mongoReplicaInstance006005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.10.117") //primary
	...
	mongoReplicaInstance006006.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.10.133")
