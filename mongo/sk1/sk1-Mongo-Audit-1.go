...
func GenerateSk1MongoAuditTemplate() {
	...
	subnetA := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "10.0/28", // check for availability of subnet CIDR, we specify 27 to reserve only 32 IPs 10.14.7.48 - 10.14.7.64
	})
	...
	MongoReplicaSetInstance010005.Ec2Instance.ImageId = cloudformation.String("ami-083ddd57181340c47")
	MongoReplicaSetInstance010005.Ec2Instance.InstanceType = cloudformation.String("r5.large")
	MongoReplicaSetInstance010005.Ec2InstanceSubnet = subnetA
	MongoReplicaSetInstance010005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.10.5") //primary
	...
	MongoReplicaSetInstance010005.MongoContainerTag = "bamboo-mongo-task-2652-mongo-9"
	...
	MongoReplicaSetInstance010021.Ec2Instance.ImageId = cloudformation.String("ami-083ddd57181340c47")
	MongoReplicaSetInstance010021.Ec2Instance.InstanceType = cloudformation.String("r5.large")
	MongoReplicaSetInstance010021.Ec2InstanceSubnet = subnetB
	MongoReplicaSetInstance010021.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.10.21")
	...
	MongoReplicaSetInstance010021.MongoContainerTag = "bamboo-mongo-task-2652-mongo-9"
	...
	MongoReplicaSetInstance010037.Ec2Instance.ImageId = cloudformation.String("ami-083ddd57181340c47")
	MongoReplicaSetInstance010037.Ec2Instance.InstanceType = cloudformation.String("r5.large")
	MongoReplicaSetInstance010037.Ec2InstanceSubnet = subnetC
	MongoReplicaSetInstance010037.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.10.37")
	...
	MongoReplicaSetInstance010037.MongoContainerTag = "bamboo-mongo-task-2652-mongo-9"
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/sk1/Mongo-Audit-1", "sk1-Mongo-Audit-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/sk1/Mongo-Audit-1", "sk1-Mongo-Audit-1-Service.json")
}
