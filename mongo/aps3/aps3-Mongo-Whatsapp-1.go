...
func GenerateAps3MongoWhatsappTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{cloudformation.ImportValue("aps3-SecurityGroup-MongoWhatsappEc2InstanceEC2SecurityGroupId")}
	...
	mongoReplicaInstance006005.Ec2Instance.ImageId = cloudformation.String("ami-02873cba8b394e858")
	...
	mongoReplicaInstance006005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.6.5")
	...
	mongoReplicaInstance006006.Ec2Instance.ImageId = cloudformation.String("ami-02873cba8b394e858")
	...
	mongoReplicaInstance006006.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.6.6") //primary
	...
	mongoReplicaInstance006020.Ec2Instance.ImageId = cloudformation.String("ami-02873cba8b394e858")
	...
	mongoReplicaInstance006020.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.6.20")
	...
	mongoReplicaInstance013020.Ec2Instance.ImageId = cloudformation.String("ami-02873cba8b394e858")
	...
	mongoReplicaInstance013020.Ec2Instance.PrivateIpAddress = cloudformation.String("10.20.13.20")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/aps3/Mongo-Whatsapp", "aps3-Mongo-Whatsapp-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/aps3/Mongo-Whatsapp", "aps3-Mongo-Whatsapp-1-Service.json")
}
