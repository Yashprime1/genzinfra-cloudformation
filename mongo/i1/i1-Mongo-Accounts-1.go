...
func GenerateI1MongoAccountsTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{
		cloudformation.ImportValue("i1-SecurityGroup-MongoInstanceEC2SecurityGroupId"),
	}
	...
	MongoReplicaSetInstance007052.Ec2Instance.ImageId = cloudformation.String("ami-03fd7be3a2a42f2ce")
	MongoReplicaSetInstance007052.Ec2Instance.InstanceType = cloudformation.String("t3.medium")
	MongoReplicaSetInstance007052.Ec2InstanceSubnet = subnetA
	MongoReplicaSetInstance007052.Ec2Instance.PrivateIpAddress = cloudformation.String("10.17.7.52")
	...
	MongoReplicaSetInstance007068.Ec2Instance.ImageId = cloudformation.String("ami-03fd7be3a2a42f2ce")
	MongoReplicaSetInstance007068.Ec2Instance.InstanceType = cloudformation.String("t3.medium")
	MongoReplicaSetInstance007068.Ec2InstanceSubnet = subnetB
	MongoReplicaSetInstance007068.Ec2Instance.PrivateIpAddress = cloudformation.String("10.17.7.68")
	...
	MongoReplicaSetInstance007100.Ec2Instance.ImageId = cloudformation.String("ami-03fd7be3a2a42f2ce")
	MongoReplicaSetInstance007100.Ec2Instance.InstanceType = cloudformation.String("t3.medium")
	MongoReplicaSetInstance007100.Ec2InstanceSubnet = subnetC
	MongoReplicaSetInstance007100.Ec2Instance.PrivateIpAddress = cloudformation.String("10.17.7.100") //primary
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/i1/i1-Mongo-Accounts-1", "i1-Mongo-Accounts-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/i1/i1-Mongo-Accounts-1", "i1-Mongo-Accounts-1-Service.json")
}
