...
func Generatemec1MongoWiredTiger3Dot6Template() {
	...
	MongoReplicaSetInstance007007.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
	...
	MongoReplicaSetInstance007007.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.7")
	...
	MongoReplicaSetInstance007022.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
	...
	MongoReplicaSetInstance007022.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.22") //primary
	...
	MongoReplicaSetInstance007038.Ec2Instance.ImageId = cloudformation.String("ami-022cae5767ebb7d1d")
