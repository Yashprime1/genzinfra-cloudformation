...
func GenerateEu1MongoDirectcallTemplate() {
	...
	defaults.Ec2Instance.SecurityGroupIds = []string{
		cloudformation.ImportValue("eu1-SecurityGroup-DirectcallMongoInstanceEC2SecurityGroupId"),
	}
	...
	MongoReplicaSetInstance013132.Ec2Instance.ImageId = cloudformation.String("ami-0d7a65c5a518a12c3")
	...
	MongoReplicaSetInstance013132.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.13.132") // primary
	...
	MongoReplicaSetInstance013148.Ec2Instance.ImageId = cloudformation.String("ami-0d7a65c5a518a12c3")
	...
	MongoReplicaSetInstance013148.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.13.148")
	...
	MongoReplicaSetInstance013164.Ec2Instance.ImageId = cloudformation.String("ami-0d7a65c5a518a12c3")
	...
	MongoReplicaSetInstance013164.Ec2Instance.PrivateIpAddress = cloudformation.String("10.11.13.164")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/eu1/Mongo-Directcall-1", "eu1-Mongo-Directcall-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/eu1/Mongo-Directcall-1", "eu1-Mongo-Directcall-1-Service.json")
}
