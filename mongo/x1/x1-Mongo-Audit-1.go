...
func GenerateX1MongoAuditTemplate() {
	...
	subnetA := mongo.NewSubnet(mongo.Subnet{
		...
		SubnetCidrBlockSuffix:  "10.0/28", // check for availability of subnet CIDR, we specify 27 to reserve only 32 IPs 10.16.7.48 - 10.16.7.64
	})
	...
	MongoReplicaSetInstance010005.Ec2Instance.ImageId = cloudformation.String("ami-00ac255069dc94e3c")
	MongoReplicaSetInstance010005.Ec2Instance.InstanceType = cloudformation.String("t2.small")
	MongoReplicaSetInstance010005.Ec2InstanceSubnet = subnetA
	MongoReplicaSetInstance010005.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.10.5") //primary
	...
	MongoReplicaSetInstance010021.Ec2Instance.ImageId = cloudformation.String("ami-00ac255069dc94e3c")
	MongoReplicaSetInstance010021.Ec2Instance.InstanceType = cloudformation.String("t2.small")
	MongoReplicaSetInstance010021.Ec2InstanceSubnet = subnetB
	MongoReplicaSetInstance010021.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.10.21")
	...
	MongoReplicaSetInstance010037.Ec2Instance.ImageId = cloudformation.String("ami-00ac255069dc94e3c")
	MongoReplicaSetInstance010037.Ec2Instance.InstanceType = cloudformation.String("t2.small")
	MongoReplicaSetInstance010037.Ec2InstanceSubnet = subnetC
	MongoReplicaSetInstance010037.Ec2Instance.PrivateIpAddress = cloudformation.String("10.16.10.37")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/x1/Mongo-Audit-1", "x1-Mongo-Audit-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/x1/Mongo-Audit-1", "x1-Mongo-Audit-1-Service.json")
}
