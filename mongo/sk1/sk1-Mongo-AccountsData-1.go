...
func GenerateSk1MongoWiredTigerAccountsData3Dot6Template() {
	...
	MongoReplicaSetInstance007052.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.7.52")
	...
	MongoReplicaSetInstance007068.Ec2Instance.PrivateIpAddress = cloudformation.String("10.14.7.68") //primary
