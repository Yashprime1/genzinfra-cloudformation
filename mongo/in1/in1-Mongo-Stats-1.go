...
func GenerateIn1MongoStatsTemplate() {
	...
	mongoReplicaInstance007116.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	...
	mongoReplicaInstance007116.MongoContainerTag = "github-sne-6117-16"
	...
	mongoReplicaInstance007132.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	mongoReplicaInstance007132.Ec2Instance.InstanceType = cloudformation.String("r5.2xlarge")
	...
	mongoReplicaInstance007132.MongoContainerTag = "github-sne-6117-16"
	...
	mongoReplicaInstance007148.Ec2Instance.ImageId = cloudformation.String("ami-03f1bfde83c761b99")
	mongoReplicaInstance007148.Ec2Instance.InstanceType = cloudformation.String("r5.2xlarge")
	...
	mongoReplicaInstance007148.MongoContainerTag = "github-sne-6117-16"
