...
func GenerateSg1MongoAccountsTemplate() {
	...
	MongoReplicaSetInstance007052.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	MongoReplicaSetInstance007052.Ec2Instance.InstanceType = cloudformation.String("r5.4xlarge")
	MongoReplicaSetInstance007052.Ec2InstanceSubnet = subnetA
	MongoReplicaSetInstance007052.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.52")
	MongoReplicaSetInstance007052.XvdpEc2Volume.Size = cloudformation.Int(96)
	...
	MongoReplicaSetInstance007068.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	MongoReplicaSetInstance007068.Ec2Instance.InstanceType = cloudformation.String("r5.4xlarge")
	MongoReplicaSetInstance007068.Ec2InstanceSubnet = subnetB
	MongoReplicaSetInstance007068.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.68")
	MongoReplicaSetInstance007068.XvdpEc2Volume.Size = cloudformation.Int(96)
	...
	MongoReplicaSetInstance007100.Ec2Instance.ImageId = cloudformation.String("ami-02df2edff7704b9fe")
	MongoReplicaSetInstance007100.Ec2Instance.InstanceType = cloudformation.String("r5.4xlarge")
	MongoReplicaSetInstance007100.Ec2InstanceSubnet = subnetC
	MongoReplicaSetInstance007100.Ec2Instance.PrivateIpAddress = cloudformation.String("10.15.7.100") //primary
	MongoReplicaSetInstance007100.XvdpEc2Volume.Size = cloudformation.Int(96)
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/sg1/sg1-Mongo-Accounts-1", "sg1-Mongo-Accounts-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/sg1/sg1-Mongo-Accounts-1", "sg1-Mongo-Accounts-1-Service.json")
}
