...
func Generatemec1MongoWiredTiger3Dot6Template() {
	...
	MongoReplicaSetInstance007007.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance007007.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.7") //primary
	...
	MongoReplicaSetInstance007022.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance007022.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.22")
	...
	MongoReplicaSetInstance007038.Ec2Instance.ImageId = cloudformation.String("ami-0c3ddec888ab9cd5e")
	...
	MongoReplicaSetInstance007038.Ec2Instance.PrivateIpAddress = cloudformation.String("10.19.7.38")
	...
	wizrocket.WriteTemplate(sTemplate, "/mongo/mec1/Mongo-MetaData-1", "mec1-Mongo-MetaData-1.json")
	wizrocket.WriteTemplate(serviceTemplate, "/mongo/mec1/Mongo-MetaData-1", "mec1-Mongo-MetaData-1-Service.json")
}
